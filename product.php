...
<?php include_once('layouts/header.php'); ?>
  ...
  <a href="filtrar_productos.php" class="btn btn-info">
    <i class="glyphicon glyphicon-search"></i> Búsqueda de artículos
  </a>
</div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> <?php echo remove_junk($product['buy_price']); ?></td>  <!-- Origen -->
                <td class="text-center"> <?php echo remove_junk($product['sale_price']); ?></td> <!-- Destino -->
